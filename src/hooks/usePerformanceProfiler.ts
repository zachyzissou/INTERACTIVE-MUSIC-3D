...
import { PerformanceMetrics, Recommendation, getPerformanceGrade } from '@/types/performance'
...
function generateRecommendations(metrics: PerformanceMetrics): Recommendation[] {
